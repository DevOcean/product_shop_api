...
ActiveRecord::Schema[7.2].define(version: 2025_01_27_222820) do
  ...
  create_table "product_rules", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_product_rules_on_product_id"
  end
  ...
  add_foreign_key "product_rules", "products"
end
